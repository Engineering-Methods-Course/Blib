...
public class BookInfoFrameController {
    ...
    public void orderBookButtonClicked() throws Exception {
         ...
         */
        if (orderComplete) {
            loadFrameIntoPane((AnchorPane) bookInfoFrame.getParent(), "/gui/fxml/SearchPageFrame.fxml");
        }
    }
    ...
    public void backButtonClicked() throws Exception {
        loadFrameIntoPane((AnchorPane) bookInfoFrame.getParent(), "/gui/fxml/SearchResultFrame.fxml");
    }
}