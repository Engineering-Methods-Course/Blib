...
public class ClientIPFrameController
{
    ...
    {
        // Load the FXML file
        FXMLLoader loader = new FXMLLoader(Objects.requireNonNull(getClass().getResource("/gui/fxml/ClientIPFrame.fxml")));
        ...
        scene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("/gui/css/MainFrame.css")).toExternalForm());
    ...
    public void clickEnterButton(ActionEvent event) throws Exception
    {
        ...
        try
        {
            ...
            navigateTo(event, "/gui/fxml/MainFrame.fxml", "/gui/css/MainFrame.css", "Home Page");
        }
