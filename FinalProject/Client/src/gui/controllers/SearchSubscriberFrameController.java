...
public class SearchSubscriberFrameController
{
    ...
    public void initialize()
    {
        ...
        Tooltip idTextFieldTooltip = new Tooltip("Enter the subscribers unique ID number (e.g. 100001), Or scan member card.");
            ...
            else
            {
                ...
                if (storedEvent != null)
                {
                    try
                    {
                        ...
                        WatchProfileFrameController.setPreviousFrame("/gui/fxml/SearchSubscriberFrame.fxml");
                        loadFrameIntoPane((AnchorPane) searchSubscriberFrame.getParent(), "/gui/fxml/WatchProfileFrame.fxml");
                    }
                    catch (Exception e)
                    {
