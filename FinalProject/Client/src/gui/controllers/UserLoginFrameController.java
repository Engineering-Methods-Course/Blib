...
public class UserLoginFrameController
{
    ...
    public void initialize()
    {
        ...
        try
        {
            ...
            {
                navigateTo(event, "/gui/fxml/MainFrame.fxml", "/gui/css/MainFrame.css", "Profile Page");
            }
            // Check if the user is a librarian that's already logged in
            else if (Librarian.getLocalLibrarian() != null)
            {
                navigateTo(event, "/gui/fxml/MainFrame.fxml", "/gui/css/MainFrame.css", "Librarian Menu");
            }
        }
        catch (Exception e)
        {
