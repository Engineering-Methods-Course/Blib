...
public class ViewAllSubscribersFrameController
{
    ...
    private void watchProfileButtonClicked(Subscriber subscriber)
    {
        ...
        try
        {
            WatchProfileFrameController.setPreviousFrame("/gui/fxml/ViewAllSubscribersFrame.fxml");
            loadFrameIntoPane((AnchorPane) allSubscribersFrame.getParent(), "/gui/fxml/WatchProfileFrame.fxml");
        }
        catch (Exception e)
        {
